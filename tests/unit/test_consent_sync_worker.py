...
def _worker() -> ConsentSyncWorker:
    """
    Create a preconfigured ConsentSyncWorker intended for tests.
    
    The returned worker uses a default settings namespace (consent_bonus_amount="100.0", consent_bonus_ttl_days=30)
    and AsyncMock instances for session_factory, listmonk_client, and teyca_client.
    
    Returns:
        ConsentSyncWorker: A ConsentSyncWorker instance configured with mock clients and default test settings.
    """
