...
async def _run_to_thread(func: object, *args: object, **kwargs: object) -> object:
    """
    Execute the given callable with the provided positional and keyword arguments and return its result.
...
def _settings() -> SimpleNamespace:
    """
    Create a SimpleNamespace containing default Listmonk connection settings used by tests.
    
    Returns:
        SimpleNamespace: An object with attributes `listmonk_url` (str), `listmonk_user` (str), and `listmonk_password` (str).
    """
