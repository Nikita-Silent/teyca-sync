...
**Подготовка к реализации:** исходный чек-лист инфраструктуры, каркаса приложения и данных
(`docs/preparation.md`) удалён после teyca-sync-9ib как описывающий давно пройденную
нулевую стадию проекта на архитектуре с RabbitMQ, которой больше нет — история в git log.
