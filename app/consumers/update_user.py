...
async def handle(
    ...
    if not is_valid_email(event.pass_data.email):
        await deps.outbox_repo.enqueue_latest(
            ...
            trace_id=trace_id,
            source_event_id=source_event_id,
            queue_name=QUEUE_UPDATE,
        )
        logger.info(
            "update_consumer_email_invalid_block_enqueued",
            user_id=user_id,
            trace_id=trace_id,
            source_event_id=source_event_id,
    ...
    _log_step(
        "update_consumer_listmonk_enqueue_start",
        user_id=user_id,
        trace_id=trace_id,
        source_event_id=source_event_id,
    ...
    if merge_needs_write:
        _log_step(
            "update_consumer_merge_enqueue_start",
            user_id=user_id,
            trace_id=trace_id,
            source_event_id=source_event_id,
        ...
        _log_step(
            "update_consumer_merge_enqueue_done",
            user_id=user_id,
            trace_id=trace_id,
            source_event_id=source_event_id,
            old_bonus_value=old_bonus_value,
