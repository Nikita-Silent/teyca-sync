...
class WebhookInbox(Base):
    """Durable inbox for incoming webhooks, replacing RabbitMQ (teyca-sync-8ib)."""

    __tablename__ = "webhook_inbox"
    __table_args__ = (UniqueConstraint("source_event_id", name="uq_webhook_inbox_source_event_id"),)
